...
renamed as (
    select
        ...
        stop_duration_seconds is not null as has_stationary_stop_duration,
        stop_duration_seconds is not null and stop_duration_seconds between 0 and 120 as is_valid_stationary_stop_duration,
        lane_duration_seconds is not null and lane_duration_seconds between 0 and 1800 as is_valid_lane_duration
    from source
)
